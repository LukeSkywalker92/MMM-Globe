...
|Option|Description|
|---|---|
|`style`|Style of the image. There are four diffrent styles available. You can preview them [here](http://rammb.cira.colostate.edu/ramsdis/online/himawari-8.asp).<br><br>**Type:** `string`<br>**Possible values:** `natColor`, `geoColor`, `airMass`, `fullBand`|
